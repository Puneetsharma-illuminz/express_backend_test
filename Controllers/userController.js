...
let dataBaseService = require("../databaseServices");
...
async function calculateDistance(payload) {
    ...
    const distanceAndTimeOfLatLong = await getGoogleResponce('30.715260,76.707771', '30.706787,76.708252');
    ...
    let selectedVehiclePrice = await dataBaseService.executeQuery('SELECT perKilometerCharge from vehicles where type = ?  ', [payload.type])
